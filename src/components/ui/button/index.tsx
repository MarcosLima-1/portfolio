...
export function Button({
	...
	return (
		<BaseUiButton
			className={cn(buttonVariants({ size, variant, className }), !hideShadow && shadowVariants({ variant, className }))}
